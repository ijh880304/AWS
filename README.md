...
> 이 문서는 [EKS](https://aws.amazon.com/ko/eks) 환경에 TIBCO BWCE(Container Edition) 제품을 배포 및 테스트 할 수 있도록 클러스터 환경 및 CI/CD 환경을 구축하는 방법을 정리한 문서입니다.
> EKS 환경은 심플하게 구성 하였으나 일반적인 운영 환경에서는 보안을 위한 네트워크 관리와 보안그룹 관리가 디테일하게 필요하니 별도로 확인 하는 것이 좋을 것 같습니다.
